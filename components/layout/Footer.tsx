                ...
                <div className="py-20 md:py-32 border-b border-zinc-800 flex flex-col lg:flex-row items-start lg:items-end justify-between gap-12">
                    <div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <Button onClick={() => onNavigate('login')} size="lg" className="text-xl px-12 h-16 bg-white text-black hover:bg-piku-lime hover:border-black border-none shadow-[8px_8px_0px_rgba(255,255,255,0.2)]">
                                Get Started Now
                            </Button>
                        </div>
                    </div>
