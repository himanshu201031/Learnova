            ...
            <div className="container mx-auto px-4 md:px-6 text-center relative z-10">
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-6">
                        <Button onClick={() => onNavigate('login')} size="lg" className="bg-white text-black hover:bg-piku-cyan hover:border-black border-transparent shadow-[0_0_30px_rgba(255,255,255,0.2)] text-xl h-20 px-10">
                            <Smartphone className="mr-2" /> Get Started
                        </Button>
                        <Button onClick={() => onNavigate('login')} size="lg" variant="outline" className="text-white border-zinc-700 hover:bg-zinc-900 hover:text-white text-xl h-20 px-10">
